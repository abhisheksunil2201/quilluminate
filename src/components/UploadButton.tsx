      ...
      {({ getRootProps, getInputProps, acceptedFiles }) => (
        ...
        >
          <div className="flex items-center justify-center h-full w-full">
            ...
            >
              <div className="flex flex-col items-center justify-center pt-5 pd-6">
              ...
              {isUploading ? (
                <div className="w-full mt-4 max-w-xs mx-auto">
                  ...
                  />
                  {uploadProgress === 100 ? (
                    <div className="flex gap-1 items-center justify-center text-center text-zinc-700 text-sm pt-2">
